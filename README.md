...
- [`Template/README.md`](Template/README.md) — copyable scraper scaffolds and template relationships.
...
- `Template/` — YAML/Python scaffolds; templates are not verified scrapers.
...
- `tools/` — repository inspection and documentation utilities.
...
1. Start from the appropriate template in `Template/`, or inspect an existing scraper.
